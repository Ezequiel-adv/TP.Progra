...
public class Gnomo {
        ...
        if (cayendo) {
            ...
            for (Isla isla : islas) {
                if (isla != null && isla.colisionaConGnomo(x, y, 20, 20)) {
                    cayendo = false; // El gnomo deja de caer
                    ...
                    islaActual = isla; // Guarda referencia de la isla actual
                    cambiarDireccionAleatoria(); // Cambia la dirección de manera aleatoria
                    break;
                }
            }
        } else {
    ...
    // Método para cambiar dirección aleatoria al tocar una isla
